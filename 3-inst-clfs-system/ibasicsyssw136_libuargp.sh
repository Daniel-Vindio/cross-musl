# Instalador de libargp
# MUSL.
#La fuente procede de https://github.com/xhebox/libuargp.git
#Ojo la lib se llama libargp. Pero el código libuargp

#libuargp-dev070119.tar.xz
nombre="libuargp"
