...
ls
control_flujo
rm -rf bin etc lib media opt root sbin srv tmp usr boot dev home lib64 \
mnt proc run sys var qipkgs command package service
...
i386-unknown-linux-musl x86_64-unknown-linux-musl
