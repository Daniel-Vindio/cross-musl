...
make ARCH=${CLFS_ARCH_k} headers_check
registro_error "make ARCH=${CLFS_ARCH_k} headers_check"

make ARCH=${CLFS_ARCH_k} INSTALL_HDR_PATH=/tools headers_install
registro_error "make ARCH=${CLFS_ARCH_k} INSTALL_HDR_PATH=/tools headers_install"
